...
def contaminated_gaussian_noise(rng: np.random.Generator,
    ...
    """Draw noise using multivariate normal distribution and inject Huber Loss
    ...
    contaminated_noise = rng.multivariate_normal(mean=mean, cov=(kappa**2)*R, method='cholesky') # Huber loss
